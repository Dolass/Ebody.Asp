...
Class ebody_aes
	...
	Function AESEncrypt(sPlain,sPassword)
		...
		lLength = Len(sPlain)
		If lLength<1 Then Exit function ' add by tony 20121101
	...
	Public Function Decode(ByVal s)
		Dim p
		p = ebody.Escape(s_pass)
		Decode = ebody.UnEscape(AESDecrypt(s,p))
	End Function

	' 创建对像操作类实例
	' 说明: 当需要创建私有对像时使用.如使用ebody.USE方法来创建,则是共用的对像
	' 调用方法: Set aes = ebody.aes.New
	Public Function [New]()
		Set [New] = New ebody_aes
	End Function
End Class
%>